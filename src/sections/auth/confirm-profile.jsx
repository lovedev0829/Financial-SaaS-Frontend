  ...
  return (
   <Stack spacing={7} >
         ...
         <Stack alignItems='center' gap={3} textAlign='center'>
            ...
            <Typography>Your profile request has been submitted successfully. We will contact you shortly.</Typography>
            <Typography>In the mean time you can see our <Link style={{color: "#69ADFF"}}>Info hub</Link></Typography>
         </Stack>
