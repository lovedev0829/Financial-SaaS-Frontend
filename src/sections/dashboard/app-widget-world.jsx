                ...
                <Grid xs={12} md={9} spacing={1} container item>
                  <Grid>
                    <Typography variant="h">
                      Bitcoin is getting even dirtier in the market of virtual currency consectetur
                  ...
                  <Grid>
                    <Stack gap={2} direction="row">
                      ...
                      <Stack direction="row">
                        <AccessTimeIcon />
                        <Typography variant="h"> 5h ago</Typography>
                      </Stack>
                      <Typography variant="h"> 680 share</Typography>
                    </Stack>
                  </Grid>
                </Grid>
                <Grid md={3} item>
                  <Image
                    src="/assets/images/news/coin1.png"
                    sx={{ borderRadius: 2, maxWidth: '68%' }}
                  />
                </Grid>
              </Grid>
              <Grid container>
                ...
                <Grid md={3} item>
                  <Image
                    src="/assets/images/news/coin2.png"
                    sx={{ borderRadius: 2, maxWidth: '68%' }}
                  />
                </Grid>
              </Grid>
