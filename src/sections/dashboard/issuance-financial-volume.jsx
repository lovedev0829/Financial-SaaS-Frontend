    ...
    fill: {
      ...
      gradient: {
        colorStops: colors.map((colr) => [
          { offset: 0, color: colr[0], opacity: 0.3 },
          { offset: 100, color: colr[1], opacity: 0.1 },
        ]),
      },
    },
    xaxis: {
            ...
            <Grid container spacing={2} sx={{justifyContent: "flex-end"}}>
              ...
              <Grid xs={12} md={2.5}>
                <Select
                  ...
                  id="assetSubtype"
                >
                  <MenuItem value={0} selected>Asset Subtype</MenuItem>
                ...
                <Grid xs={12} md={2.5}>
                  <Select
                    ...
                    id="distributor"
                  >
                    <MenuItem value={0} selected>Distributor</MenuItem>
                  </Select>
                </Grid>
            </Grid>
        </Box>
